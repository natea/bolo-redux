...
# Handle Claude Flow's generated CLAUDE.md
if [ -f "$WORKSPACE_FOLDER/CLAUDE.md" ]; then
    echo "Found CLAUDE.md generated by Claude Flow, renaming to CLAUDE.md.OLD..."
    mv "$WORKSPACE_FOLDER/CLAUDE.md" "$WORKSPACE_FOLDER/CLAUDE.md.OLD"
    echo "✅ Renamed Claude Flow's CLAUDE.md to CLAUDE.md.OLD"
fi
